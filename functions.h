int replace_commas(char target_str[], int str_len);
void change_asterik_remove_quotes(char target_str[]);
void scan_values(char temp_str[], int* footpath_id, char* address, char* clue_sa, char* asset_type, double* 
